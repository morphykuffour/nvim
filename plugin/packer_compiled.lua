...
_G.packer_plugins = {
  ...
  ["YankRing.vim"] = {
    loaded = true,
    path = "/home/morp/.local/share/nvim/site/pack/packer/start/YankRing.vim",
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/morp/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  ["onehalf-lush"] = {
    loaded = true,
    path = "/home/morp/.local/share/nvim/site/pack/packer/start/onehalf-lush",
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/home/morp/.local/share/nvim/site/pack/packer/start/trouble.nvim",
  ...
  ["vim-slime"] = {
    loaded = true,
    path = "/home/morp/.local/share/nvim/site/pack/packer/start/vim-slime",
