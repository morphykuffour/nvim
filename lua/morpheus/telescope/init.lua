...
require("telescope").setup {
    ...
    extensions = {
        ...
        -- frecency = {
        --     workspaces = {
        --         ["dotfiles"]    = "/home/morp/dotfiles",
        --         ["nvim_config"] = "/home/morp/.config/nvim/",
        --     },
        -- },
...
--         require "morpheus.telescope.frecency"
--     end
...
return setmetatable({}, {
    __index = function(_, k)
        ...
        local has_custom, custom = pcall(require, string.format("morpheus.telescope.custom.%s", k))
