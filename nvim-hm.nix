...
in
{
  ...
  programs.neovim = {
    ...
    extraConfig = builtins.concatStringsSep "\n" [
      ...
      # Todo for loop
      (lib.strings.fileContents ./vimfiles/beautify.vim)
      (lib.strings.fileContents ./vimfiles/binary.vim)
      (lib.strings.fileContents ./vimfiles/build.vim)
      (lib.strings.fileContents ./vimfiles/cscope_maps.vim)
      (lib.strings.fileContents ./vimfiles/cyclist.vim)
      (lib.strings.fileContents ./vimfiles/functions.vim)
      (lib.strings.fileContents ./vimfiles/mappings.vim)
      (lib.strings.fileContents ./vimfiles/netrw.vim)
      (lib.strings.fileContents ./vimfiles/newbiecructches.vim)
      (lib.strings.fileContents ./vimfiles/scratch.vim)
      (lib.strings.fileContents ./vimfiles/startup.vim)
      (lib.strings.fileContents ./vimfiles/wilder.vim)
